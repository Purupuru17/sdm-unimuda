                                          ...
                                          <tr>
                                             <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                   <tbody>
                                                      <tr>
                                                         <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #428bca; margin: 0px; font-size: 14px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
                                                            <h2 style="color: #428bca"><?= $nama ?>, </h2>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                                <div style="font-family: Arial, sans-serif; line-height: 16px; color: #dd5a43; font-size: 16px;">
                                                    <?= $pesan ?> 
                                                </div>
                                             </td>
                                          </tr>
