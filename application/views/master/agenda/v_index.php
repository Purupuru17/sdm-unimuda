    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <form id="search-form" action="#" name="form" class="form-horizontal" method="POST">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-2 no-padding-right">Presensi :</label>
                    <div class="col-xs-12 col-sm-2">
                        <div class="clearfix">
                            <select class="select2 width-100" name="presensi" id="presensi" data-placeholder="----> Pilih Opsi <----">
                                <option value=""> </option>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.date-picker').datepicker({
            autoclose: true, todayHighlight: true, format: "mm-yyyy",
    ...
    function loadIndex() {
        const indexTable = new DataTableManager("#index-table", {
            ...
            aoColumnDefs: [
                ...
                {sClass: "center nowrap", aTargets: [1,6]}
            ]
        }).init();
