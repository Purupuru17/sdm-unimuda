                    ...
                    <div class="widget-main padding-2 table-responsive">
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                                <tr>
                                    <td><?= ctk($no); ?></td>
                                    <td><?= ctk($row['judul_jenis']); ?></td>
                                    <td><?= ctk($row['slug_jenis']); ?></td>
                                    <td><span style="background-color:<?= $row['color_jenis']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                                    <td><i style="color:<?= $row['color_jenis']; ?>" class="bigger-150 <?= $row['icon_jenis'] ?>"></i></td>
                                    <td nowrap>
                                        <div class="action-buttons">
                                            <a href="<?= site_url($module .'/edit/'. encode($row['id_jenis'])) ?>" class="tooltip-warning btn btn-white btn-warning btn-sm" data-rel="tooltip" title="Ubah Data">
                                                    <span class="orange"><i class="ace-icon fa fa-pencil-square-o bigger-130"></i></span>
                                                </a>
                                            <a href="#" name="<?= encode($row['id_jenis']) ?>" itemprop="<?= $row['judul_jenis'] ?>" id="delete-btn" class="hide tooltip-error btn btn-white btn-danger btn-sm" data-rel="tooltip" title="Hapus Data">
